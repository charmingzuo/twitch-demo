...
var AbstractAPI = (function () {
    ...
    AbstractAPI.prototype.request = function (query, cb) {
        ...
        log_2.default.debug(JSON.stringify(this));
        ...
        request({
            ...
            if (!err && res.statusCode == 200) {
                try {
                    ...
                    log_2.default.error(me.getPathname() + " \u89E3\u6790Twitch\u8FD4\u56DE\u503C\u5931\u8D25 " + e.message);
                    err = messages_1.default.ERR_PARSE_JSON_FAILED;
                }
            }
            if (json) {
                log_2.default.info('请求Twitch接口成功');
                log_1.default.info(JSON.stringify(json));
                cb(null, json);
            }
            else {
                log_2.default.error("err=" + (err || '') + ", statusCode=" + (res ? res.statusCode : '') + ", body=" + JSON.stringify(body));
